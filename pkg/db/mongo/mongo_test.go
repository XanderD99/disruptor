...
func TestMongoConnect(t *testing.T) {
	...
	err := sharedTestDB.Create(ctx, user)
	if err != nil {
		t.Errorf("Failed to create test document: %v", err)
	}

	// Clean up
	sharedTestDB.Delete(ctx, user)
}
...
func TestMongoCreate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := sharedTestDB.Create(ctx, tt.entity)
			...
			// Cleanup
			if tt.cleanup {
				sharedTestDB.Delete(ctx, tt.entity)
			}
		})
	}
}
...
func TestMongoFindByID(t *testing.T) {
	...
	defer sharedTestDB.Delete(ctx, user)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var result TestUser
			err := sharedTestDB.FindByID(ctx, tt.id, &result)
...
func TestMongoFindAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := sharedTestDB.Find(ctx, &results, tt.options...)
			assert.NoError(t, err, "Unexpected error: %v", err)
...
func TestMongoUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := sharedTestDB.Update(ctx, tt.entity)
...
func TestMongoUpsert(t *testing.T) {
	...
	defer sharedTestDB.Delete(ctx, user)
	defer sharedTestDB.Delete(ctx, TestUser{ID: "upsert_new"})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := sharedTestDB.Upsert(ctx, tt.entity)
			assert.NoError(t, err, "Unexpected error: %v", err)
		})
	}
}
...
func TestMongoDelete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := sharedTestDB.Delete(ctx, tt.user)
			...
			if tt.expectError {
				...
				if tt.user.ID == "delete_test_1" {
					var result TestUser
					err := sharedTestDB.FindByID(ctx, tt.user.ID, &result)
					if err == nil {
	...
	sharedTestDB.Delete(ctx, users[1])
}
...
func TestMongoCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			count, err := sharedTestDB.Count(ctx, TestUser{}, tt.options...)
			if err != nil {
				t.Errorf("Unexpected error: %v", err)
				return
			}
...
func TestMongoComplexQueries(t *testing.T) {
	...
	for _, order := range orders {
		err := sharedTestDB.Create(ctx, order)
		if err != nil {
			t.Fatalf("Failed to create test data: %v", err)
		}
	}
